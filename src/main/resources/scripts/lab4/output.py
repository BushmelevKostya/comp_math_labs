def print_best_answer(answers, best_num):
    if best_num == 0:
        ...
        print("Polynomial_2 sqr coefficient is: ", round(answers[1][3], 3))
        print("Polynomial_3 determination coefficient is: ", round(answers[2][4], 3))
        print("Polynomial_3 sqr coefficient is: ", round(answers[2][3], 3))
        print("Power determination coefficient is: ", round(answers[3][4], 3))
        print("Power sqr coefficient is: ", round(answers[3][3], 3))
        print("Exponential determination coefficient is: ", round(answers[4][4], 3))
        print("Exponential sqr coefficient is: ", round(answers[4][3], 3))
        print("Logarithmic determination coefficient is: ", round(answers[5][4], 3))
        print("Logarithmic sqr coefficient is: ", round(answers[5][3], 3))
    elif best_num == 1:
        ...
        print("Linear sqr coefficient is: ", round(answers[0][3], 3))
        print("Polynomial_3 determination coefficient is: ", round(answers[2][4], 3))
        print("Polynomial_3 sqr coefficient is: ", round(answers[2][3], 3))
        print("Power determination coefficient is: ", round(answers[3][4], 3))
        print("Power sqr coefficient is: ", round(answers[3][3], 3))
